        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="?hal=pembayaran_hapus&id_pembayaran=<?= $data['id_pembayaran']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data?')">Hapus</a>
                    </td>
                </tr>
            <?php
            }
